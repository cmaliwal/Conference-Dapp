...
contract('Conference', function (accounts) {
    ...
    var speaker1_fullName = "chirag maliwal";
    var speaker2_account = accounts[2];
    var speaker2_fullName = "ankit rathod";
    var attendee1 = accounts[3];
    var attendeed1_FullName = "archit soni";
    var attendee2 = accounts[4];
    var attendeed2_FullName = "aman kumar";
    ...
    it("should be initialized with empty values", function() {
        return Conference.deployed().then(function(instance) {
            ...
            assert.equal(data, 0, "number of talks must be zero");
        });
    });
