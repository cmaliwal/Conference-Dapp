...
contract Conference is Ownable {
    ...
    */
    ...
    function getRewards(address _speaker) public view returns (uint[] _talksId, uint256[] _rewards) {
    ...
    function computeReward(uint ratings, uint votes) internal pure returns (uint256) {
